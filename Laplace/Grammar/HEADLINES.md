...
Remaining for general `d`: iterated one-variable Cauchy coefficient extraction with the product majorant `|c_γ| ≤ M r^{-|γ|}` (Astra #30: gate = quantitative two-coordinate lemma; 12–20 units).
