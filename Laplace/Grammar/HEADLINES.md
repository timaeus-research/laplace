...
Not formalised: the Cauchy-estimate bridge from holomorphy on a polydisc to `∑|c_γ| < ∞`, the explicit coefficient series, the `∂_μ` half of the derivative dictionary.
