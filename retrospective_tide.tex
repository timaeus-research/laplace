...
\toprule
\textbf{Tide step} & \textbf{Direction} & \textbf{Lines} & \textbf{Build}\\
\midrule
1. \texttt{quartic-moments}    & ``extend to simple degenerate cases'' & 379 & 4s\\
2. \texttt{2d-semi-degenerate} & ``Candidate D from previous'' (``Next'') & 514 & 12s\\
3. \texttt{universal-scaling}  & ``formalise the universal scaling formula'' & 206 & 8s\\
\midrule
\multicolumn{2}{r}{\emph{Total new Lean for tide loop}} & \textbf{1099} & \\
\bottomrule
\end{tabular}
\caption{The three Tide-loop excursions of 1 May 2026. The Tide-step
identifier doubles as the branch name (\texttt{tide/<id>}); branches
are rebased linearly so each step's seabed is the previous step's tip.}
...
is \texttt{sri/projects/automation/log/2026-05-01-tide-degenerate-quartic-cov.md}.}
