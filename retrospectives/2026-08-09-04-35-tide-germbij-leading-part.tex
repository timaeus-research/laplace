...
\begin{itemize}
\item The multivariate turnkey composite: leading-part instantiation +
\texttt{sector\_lower\_bound\_multi} + the multivariate composite, mirroring
the 1D corollary/turnkey pair.
