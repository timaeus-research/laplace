...
theorem iterLogRem_succ_eq ... (hL : 1 ≤ L) (hb : ∀ L, 1 ≤ L → |iterLogRem β a m L| ≤ M / L) :
...
\texttt{continuousOn\_finsetSum}, \texttt{Finset.sum\_range\_succ'}, \texttt{norm\_integral\_le\_of\_norm\_le},
